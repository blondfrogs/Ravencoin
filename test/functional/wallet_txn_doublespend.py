...
class TxnMallTest(BlastTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 BLAST:
        ...
        # First: use raw transaction API to send 1240 BLAST to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 BLAST coin each
        ...
        # Node0's balance should be starting balance, plus 50BLAST for another
        ...
        # Node0's total balance should be starting balance, plus 100BLAST for 
