...
By default, blastd will dump mempool on shutdown and
...
class MempoolPersistTest(BlastTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give blastd a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent blastd from writing mempool.dat to disk. Verify that `savemempool` fails")
