...
# TestNode: A peer we use to send messages to blastd, and store responses.
...
class CompactBlocksTest(BlastTestFramework):
    ...
    # This test actually causes blastd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that blastd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for blastd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # blastd will not send blocktxn responses for blocks whose height is
