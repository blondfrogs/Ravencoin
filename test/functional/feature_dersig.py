...
class BIP66Test(BlastTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # blastd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and blastd produces more specific reject
            # reasons.
