...
class WalletTest(BlastTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 BLAST from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 BLAST with subtract fee from amount
        ...
        # Sendmany 10 BLAST with subtract fee from amount
