...
class TxnMallTest(BlastTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 BLAST:
        ...
        # 40 BLAST serialized is 00286bee00000000
        pos0 = 2*(4+1+36+1+4+1)
        ...
        # Check node0's total balance; should be same as before the clone, + 100 BLAST for 2 matured,
