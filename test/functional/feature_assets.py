...
class AssetTest(BitcoinTestFramework):
    ...
    def big_test(self):
        ...
        n0.issue("BLAST1", 1000)
        n0.issue("BLAST2", 1000)
        n0.issue("BLAST3", 1000)
        n0.generate(1)
        self.sync_all()

        n0.listassets(asset="BLAST*", verbose=False, count=2, start=-2)
        ...
        blast_assets = n0.listassets(asset="BLAST*", verbose=False, count=2, start=-2)
        assert_equal(len(blast_assets), 2)
        assert_equal(blast_assets[0], "BLAST2")
        assert_equal(blast_assets[1], "BLAST3")
        self.sync_all()
