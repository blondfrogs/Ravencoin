...
//
//     src/qt/test/test_blast-qt -platform xcb      # Linux
//     src/qt/test/test_blast-qt -platform windows  # Windows
//     src/qt/test/test_blast-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: blast:")) != -1);
