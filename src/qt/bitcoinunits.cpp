...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BLAST: return QString("BLAST");
    case mBLAST: return QString("mBLAST");
    case uBLAST: return QString::fromUtf8("μBLAST");
...
QString BitcoinUnits::description(int unit)
{
    ...
    {
    case BLAST: return QString("BLAST");
    case mBLAST: return QString("Milli-BLAST (1 / 1" THIN_SP_UTF8 "000)");
    case uBLAST: return QString("Micro-BLAST (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    default: return QString("???");
    }
}
...
qint64 BitcoinUnits::factor(int unit)
{
    switch(unit)
    {
    case BLAST:  return 100000000;
    case mBLAST: return 100000;
    case uBLAST: return 100;
    default:   return 100000000;
    }
}

qint64 BitcoinUnits::factorAsset(int unit)
{
    switch(unit)
    {
        case 0:  return 1;
...
int BitcoinUnits::decimals(int unit)
{
    ...
    {
    case BLAST: return 8;
    case mBLAST: return 5;
    case uBLAST: return 2;
    default: return 0;
    }
}

QString BitcoinUnits::format(int unit, const CAmount& nIn, bool fPlus, SeparatorStyle separators, const int nAssetUnit)
{
...
{
    return format(BLAST, amount / factorAsset(MAX_ASSET_UNITS - unit), plussign, separators, unit) + QString(" ") + customName;
}
