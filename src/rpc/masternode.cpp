...
/*UniValue getpoolinfo(const JSONRPCRequest& request)
{
    ...
    if (vpwallets[0]) {
        obj.push_back(Pair("keys_left",     vpwallets[0]->nKeysLeftSinceAutoBackup));
        obj.push_back(Pair("warnings",      vpwallets[0]->nKeysLeftSinceAutoBackup < PRIVATESEND_KEYS_THRESHOLD_WARNING
