...
static const int MASTERNODE_SYNC_TICK_SECONDS    = 3;
static const int MASTERNODE_SYNC_TIMEOUT_SECONDS = 16; // our blocks are 32 seconds so 16 seconds should be fine
