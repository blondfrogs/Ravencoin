...
#include "algo/ethhash/hash_types.h"
...
struct ethash_result ethash_hash(const struct ethash_epoch_context_full* context,
...
bool ethash_verify_final_hash(const union ethash_hash256* header_hash,
    ...
    const union ethash_hash256* boundary, uint8_t x16r_algo) NOEXCEPT;
