...
Below are some notes on how to build BLAST Core for Windows.
...
way. This will install to `c:\workspace\blast`, for example:

    make install DESTDIR=/mnt/c/workspace/blast
