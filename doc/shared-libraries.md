...
The purpose of this library is to make the verification functionality that is critical to BLAST's consensus available to other applications, e.g. to language bindings.
