...
find ${DISTNAME}/bin -type f -executable -exec ../blast-core/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../blast-core/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/blast-core/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/blast-core/depends/SDKs/MacOSX10.11.sdk.tar.gz
